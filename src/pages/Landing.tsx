    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold">WiseON</h1>
            </div>
            ...
            <button
              ...
              className="bg-white text-gray-800 px-6 py-2 rounded-lg font-medium hover:bg-gray-100 transition-all duration-200"
            >
              로그인
            </button>
          </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-blue-600 text-white py-4 text-center">
          <p className="text-lg font-medium">공공클라우드 선정 SaaS, 조달등록제품, 혁신조달선정</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white text-gray-800 p-8 rounded-lg">
              ...
              <p className="text-gray-600">학교 운영에 필요한 다양한 조사를 자동으로 분석하고 보고서를 생성합니다.</p>
            </div>
            <div className="bg-white text-gray-800 p-8 rounded-lg">
              <h3 className="text-2xl font-bold mb-4">교우관계분석</h3>
              <p className="text-gray-600">학생들의 교우관계를 쉽게 모니터링하고 분석할 수 있습니다.</p>
            </div>
            <div className="bg-white text-gray-800 p-8 rounded-lg">
              <h3 className="text-2xl font-bold mb-4">LLM 기반의 지도 리포트 제공</h3>
              <p className="text-gray-600">LLM 기반으로 학생들의 지도 리포트를 자동으로 생성합니다.</p>
            </div>
          ...
          <div className="bg-blue-600 text-white text-center py-8 rounded-lg mt-12">
            <p className="text-2xl font-bold mb-4">학교업무를 획기적으로 경감할 수 있습니다</p>
            <button
      ...
      <section id="survey-analysis" className="py-3 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-800 mb-6">학교 운영 조사</h2>
              <p className="text-lg text-gray-600 mb-6">
                학교 운영에 대한 피드백을 쉽고 빠르게 수집할 수 있으며, 50개 이상의 검증된 학교 전용 설문을 원클릭으로 제공합니다
              </p>
              <button className="text-blue-600 hover:text-blue-800 font-medium">더보기 {'>'}</button>
            </div>        
            {/* 오른쪽: 이미지만 표시 */}
      ...
      <section className="py-3 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-800 mb-6">분석보고서 자동화</h2>
              <p className="text-lg text-gray-600 mb-6">
                AI가 표, 그래프, 해석이 포함된 분석보고서를 자동으로 생성하며, 모든 결과는 웹/리포트로 제공되고 자동 해석이 포함됩니다
              </p>
              <button className="text-blue-600 hover:text-blue-800 font-medium">더보기 {'>'}</button>
            </div>        
            {/* 오른쪽: 이미지만 표시 */}
      ...
      <section className="py-3 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-800 mb-6">교우관계분석</h2>
              <p className="text-lg text-gray-600 mb-6">
                WiseON의 교우관계분석은 소셜네트워크분석방법론 (SNA)을 적용하여 학급 내 학생들간의 교우관계를 시각적으로 표현하고 현 상태를 진단합니다
              </p>
              <button className="text-blue-800 hover:text-blue-800 font-medium">더보기 {'>'}</button>
            </div>        
            {/* 오른쪽: 이미지만 표시 */}
            <div className="bg-gray-100 p-2 rounded-lg">
              <img 
      ...
      <section className="py-3 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-800 mb-6">고급 통계 분석</h2>
              <p className="text-lg text-gray-600 mb-6">
                코로나로 인한 비대면수업교육이 학생의 학업 무기력에 어떤 영향을 미쳤나?(회귀분석) 학교 현장연구 / 논문분석 / 학생 연구지도를 위한 자동화 통계분석 솔루션도
              </p>
              <button className="text-blue-600 hover:text-blue-800 font-medium">더보기 {'>'}</button>
            </div>        
            {/* 오른쪽: 이미지만 표시 */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-0">
            ...
            <div className="bg-white border-2 border-blue-300 p-6 rounded-full text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="font-bold text-lg mb-2 text-gray-800">공공 SaaS 선정</h3>
            ...
            {/* 인텔리전스 대상 */}
            <div className="bg-white border-2 border-blue-300 p-6 rounded-full text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="font-bold text-lg mb-2 text-gray-800">인텔리전스</div>
              <h3 className="font-bold text-lg mb-2 text-gray-800">대상</h3>
              <p className="text-sm text-gray-600 mb-1">AI조사분석자동레포팅 솔루션</p>
              <p className="text-sm text-gray-600">'데이터인'개발</p>
            </div>

            {/* 2009 제14회 디지털이노베이션 대상 */}
            <div className="bg-white border-2 border-blue-300 p-6 rounded-full text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="font-bold text-lg mb-2 text-gray-800">2009 제 14회</div>
              <h3 className="font-bold text-lg mb-2 text-gray-800">디지털이노베이션 대상</h3>
            ...
            <div className="bg-white border-2 border-blue-300 p-6 rounded-full text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="font-bold text-lg mb-2 text-gray-800">2023</div>
              <h3 className="font-bold text-lg mb-2 text-gray-800">경제부총리상 수상</h3>
            ...
            {/* 디지털 서비스 혁신 제품 등록 */}
            <div className="bg-white border-2 border-blue-300 p-6 rounded-full text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="font-bold text-lg mb-2 text-gray-800">디지털 서비스</div>
              <h3 className="font-bold text-lg mb-2 text-gray-800">혁신제품 등록</h3>
      ...
      <footer className="bg-white text-gray-700 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {/* 서비스 소개 */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-gray-800">서비스 소개</h4>
              <ul className="space-y-2 text-gray-600">
                <li><a href="#" className="hover:text-blue-600 transition-colors">학교운영조사</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">분석 보고서 자동화</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">학교 시설 관리</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">교우관계분석</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">고급통계분석</a></li>
              </ul>
            </div>
            
            {/* 헬프센터 */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-gray-800">헬프센터</h4>
              <ul className="space-y-2 text-gray-600">
          ...
          <div className="border-t border-gray-200 pt-8 mb-8">
            <div className="flex flex-col md:flex-row items-start md:items-right justify-between">
              ...
              <p className="text-sm text-gray-600">대표이사 : 김원표, 사업자등록번호 : 113-86-13917</p>
                <p>서울특별시 강남구 언주로 309 기성빌딩 3층 (주)와이즈인컴퍼니</p>
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 mb-4 md:mb-0">
                <a href="#" className="text-gray-600 hover:text-blue-600 underline font-medium">개인정보처리방침</a>
                <a href="#" className="text-gray-600 hover:text-blue-600 underline font-medium">이용약관</a>
                <p className="text-sm text-gray-500">Copyright WISEINCOMPANY CO.,LTD ALL Right Reserved</p>
              </div>
