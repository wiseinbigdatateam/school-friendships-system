    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative flex h-[700px] items-center justify-center overflow-hidden max-md:h-[480px]">
        ...
        <div className="z-20 mx-auto flex w-full flex-col items-center gap-3 px-4 text-center text-white">
          <h1 className="text-6xl font-bold leading-[120%] max-md:text-4xl">
            <span className="slide-in-bck-center delay-100">
              AI기반 소외학생 예방관리 플랫폼
            </span>
          </h1>
          <p className="slide-in-bck-center text-base delay-300 max-md:text-sm">
            교사의 교권보호를 위한 데이터 기반 학생관리
          </p>
          <button
            onClick={handleSolutionClick}
            className="w-[191px] rounded-[50px] bg-sky-700 px-8 py-4 text-xl text-white transition-all duration-200 max-md:w-[150px] max-md:px-6 max-md:py-3 max-md:text-base"
          >
            솔루션 체험하기
          </button>
        </div>
