    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <div className="mt-2 flex justify-center text-xs text-gray-500">
            <div className="flex items-center space-x-14">
              <span className="text-center">약관동의</span>
              <span className="text-center">개인정보</span>
              <span className="text-center">학교정보</span>
            </div>
          </div>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {step === 3 && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">학교정보 입력</h3>
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="flex-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10"
          ...
          <div className="text-center space-y-3">
            ...
            <div>
              <button
                onClick={() => navigate('/')}
                className="inline-flex items-center space-x-2 text-[#3F80EA] transition-colors hover:text-blue-600"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
                ...
                <span className="text-base">홈으로 가기</span>
              </button>
            </div>
          </div>
        </form>
