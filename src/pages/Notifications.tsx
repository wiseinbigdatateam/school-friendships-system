          ...
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                >
                  ...
                  <option value="read">
                    읽음 ({notifications.filter((n) => n.is_read).length})
                  </option>
                </select>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-4 text-sm text-gray-600">
                ...
                <span>
                  읽지 않음: {notifications.filter((n) => !n.is_read).length}개
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="flex items-center space-x-1 rounded-lg bg-green-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-green-600 disabled:cursor-not-allowed disabled:bg-gray-300"
                >
                ...
                <button
                  ...
                  disabled={selectedNotifications.length === 0}
                  className="flex items-center space-x-1 rounded-lg bg-red-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-red-600 disabled:cursor-not-allowed disabled:bg-gray-300"
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span>삭제</span>
                  {selectedNotifications.length > 0 && (
                    <span className="ml-1 rounded-full bg-red-600 px-2 py-0.5 text-xs">
                  ...
                  <div className="flex flex-1 items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="mb-2 flex items-center space-x-3">
                        ...
                        <span
                          className={`rounded-full border px-2 py-1 text-xs font-medium ${getTypeColor(notification.type)}`}
                        >
