          ...
          <div className="flex items-center space-x-4">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-200">
                      <button
                        ...
                        className="w-full px-4 py-2 bg-[#3F80EA] text-white rounded-lg hover:bg-[#3F80EA] transition-colors"
                      >
                        전체보기
                      </button>
                    </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="w-6 h-6 bg-[#3F80EA] rounded-full flex items-center justify-center">
                  ...
                  <div className="py-1">
                    <div className="px-4 py-3 border-b border-gray-100">
                      <div className="flex items-center space-x-2 mb-1">
                        <div className="w-8 h-8 bg-[#3F80EA] rounded-full flex items-center justify-center">
