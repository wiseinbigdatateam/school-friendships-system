    ...
    <div className="mx-auto flex w-[1280px] flex-col gap-[72px] py-[72px]">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col">
          {/* 회색 카드 영역 */}
          <div className="flex flex-col gap-2 rounded-t-3xl bg-[#f4f4f4] p-10">
            {/* 종합진단 */}
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="gap-2 text-center text-xl font-semibold">
                학교생활과 네트워크 위치
              </p>
          ...
          {/* 초록색 카드 영역 */}
          <div className="flex flex-col gap-2 rounded-b-3xl bg-emerald-600 p-10">
            <img
              src="/landing/tab2/ellipsis_vertical_white.svg"
              alt="말줄임표 아이콘"
              className="w-4 self-center pb-10 pt-6"
            />
