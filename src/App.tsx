...
const ProtectedLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const navigationItems = [
    ...
    },
    {
      ...
      icon: 'clipboard',
      children: [
        { id: 'survey-templates', label: '설문 템플릿', href: '/survey-templates', icon: 'template' },
        { id: 'survey-management', label: '설문 운영', href: '/survey-management', icon: 'settings' }
      ]
    },
    {
      id: 'network',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header logo="학생 교우관계 분석 시스템" navigationItems={navigationItems} />
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/survey-templates" element={
            <ProtectedRoute>
              <ProtectedLayout>
                <SurveyTemplates />
              </ProtectedLayout>
          ...
          <Route path="/survey-monitoring/:surveyId" element={
            <ProtectedRoute>
              <ProtectedLayout>
                <SurveyMonitoring />
              </ProtectedLayout>
          ...
          <Route path="/individual-analysis" element={
            <ProtectedRoute>
              <ProtectedLayout>
                <IndividualAnalysis />
              </ProtectedLayout>
          ...
          <Route path="/class-survey" element={
            <ProtectedRoute>
              <ProtectedLayout>
                <ClassSurvey />
              </ProtectedLayout>
          ...
          <Route path="/admin" element={
            <ProtectedRoute requiredRole={["main_admin", "district_admin", "school_admin"]}>
              <ProtectedLayout>
                <Admin />
              </ProtectedLayout>
            </ProtectedRoute>
